...
#define OLED_W_SDA(x)                                                          \
  HAL_GPIO_WritePin(OLED_SDA_GPIO_Port, OLED_SDA_Pin, (GPIO_PinState)x)
#define OLED_W_SCL(x)                                                          \
  HAL_GPIO_WritePin(OLED_SCL_GPIO_Port, OLED_SCL_Pin, (GPIO_PinState)x)
